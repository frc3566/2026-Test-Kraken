...
import static frc.robot.Constants.Vision.robotToCamera;
...
public class NewChaseTagCommand extends Command {
  ...
  public void execute() {
    ...
    var photonRes = photonResList.size() > 0 ? photonResList.get(photonResList.size() - 1) : null;
      ...
      if (targetOpt.isPresent()) {
        ...
        if (!target.equals(lastTarget)) {
          ...
          var transform = new Transform2d(
            ...
            var cameraPose = robotPose.transformBy(robotToCamera.inverse());
